                        ...
                        >
                            {!isAudio(attachment) && (
                                <a
                                   ...
                                   download
                                   href={attachment.url}
                                   className="z-20 opacity-100 group-hover:opacity-100 transition-all w-9 h-8 flex items-center justify-center text-gray-100 bg-gray-700 rounded absolute right-0 top-0 cursor-pointer hover:bg-gray-800" 
                                >
                            ...
                            {isVideo(attachment) && (
                                <div className="relative flex justify-center items-center">
                                    <PlayCircleIcon className="w-16 h-16 text-white absolute z-20 opacity-70"/>
